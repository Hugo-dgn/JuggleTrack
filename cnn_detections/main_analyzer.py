...
def find_catch_events(video_path, model_path='../grid_models/grid_model_submovavg_64x64.h5', n_balls=3):
    """
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Analyze a juggling video to find all catch events.")
